...
const RealTimeTranscription = () => {
  ...
  const startRecording = async () => {
    try {
      ...
      const SLICE_MS = 3000; // Increase to 3s for better audio quality
      let isSlicing = false;
      ...
      console.log('🎤 Starting MediaRecorder...');
      // Start recording continuously and use requestData() for chunks
      mediaRecorder.start();
      
      // Create interval to request data every 2 seconds
      // This ensures each blob has a proper WebM header
      const SLICE_MS = 2000;
      const sliceTimer = setInterval(() => {
